...
export const es: Catalog = {
  "app.tagline": "NexPanel — el panel de control de hosting rápido y moderno.",
  ...
  "auth.login.subtitle": "Bienvenido de nuevo a NexPanel",
  ...
  "auth.bootstrap.title": "Bienvenido a NexPanel",
