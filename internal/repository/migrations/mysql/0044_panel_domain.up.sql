-- The panel's own base domain (MySQL/MariaDB).
--
...
-- 253 is the maximum length of a fully-qualified domain name; 45 covers an
-- IPv4-mapped IPv6 literal, which is the longest thing net.ParseIP accepts.
ALTER TABLE panel_setup ADD COLUMN panel_domain VARCHAR(253) NOT NULL DEFAULT '';
ALTER TABLE panel_setup ADD COLUMN panel_ipv4 VARCHAR(45) NOT NULL DEFAULT '';
