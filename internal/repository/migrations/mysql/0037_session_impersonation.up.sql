...
ALTER TABLE sessions
    ADD COLUMN impersonator_user_id BIGINT UNSIGNED NULL,
    ADD CONSTRAINT fk_sessions_impersonator FOREIGN KEY (impersonator_user_id) REFERENCES users(id) ON DELETE CASCADE;
